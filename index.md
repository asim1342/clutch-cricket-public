...
Unity Economy receives the random Unity player identifier and purchase data needed to validate a Google Play order, including the product identifier, signed store receipt or purchase token, transaction information, local price and currency. It keeps the authoritative purchased-Gem balance and Story Pass or Founder Pack entitlements. The game grants paid items only after Unity Economy reports a valid receipt. This helps prevent fraud, duplicate delivery and loss of verified purchases on a later launch of the same Unity player account.
