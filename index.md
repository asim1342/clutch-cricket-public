...
You can play without creating an account. Your career, preferences and gameplay records are stored on your device. This release does not send these records to us and does not include advertising, in-app purchases, online multiplayer, cloud saves or remote analytics services. Audio is included in the game; it does not record your voice.
...
The current release has no internet permission and no enabled remote analytics, Unity cloud diagnostics, advertising or account service. We do not receive local gameplay records automatically, sell them, or share them with advertisers.

## Permissions and audio

The game uses Android's vibration permission for optional haptic feedback. You can turn haptics off in Settings. It does not request camera, microphone, contacts or location permissions. Sound effects, music and number calls play from bundled assets. The Android text-to-speech fallback is disabled in this release.

## Google Play and device services

Google Play and Android may independently process installation, device and diagnostic information under their settings and policies. For example, eligible crash, unresponsive-app and performance reports may be made available to us through Android vitals. We use available reports to identify and fix reliability problems. This is separate from the game's local event logs; the game contains no enabled remote crash-reporting SDK.
...
There is no game account to delete, and we cannot remotely retrieve or erase records that exist only on your device. Google and GitHub control retention of information they collect through their own services.
...
We will update this page and its effective date if the game's data practices change. Any future addition of online services, advertising or remote analytics will require updated disclosures and any consent required by applicable law. This policy describes the current offline release, not experimental or older development builds.
